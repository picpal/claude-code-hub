...
claude --effort max     # 최대 사고 깊이 (가장 깊은 추론)
```
...
- **Auto Mode**: AI 기반 권한 분류기가 자동 판단 (Sonnet 4.6 / Opus 4.6 이상).
...
> **Auto Mode**는 Sonnet 4.6 또는 Opus 4.6 이상 모델에서 사용 가능합니다. AI 분류기가 각 작업의 안전성을 판단하여 자동으로 승인/거부합니다.
...
| 모델 | 적합한 작업 |
|------|-------------|
| **Opus 4.8** | 복잡한 아키텍처 변경, 다중 파일 수정, 보안 로직 |
